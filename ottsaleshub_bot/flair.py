...
_STATIC_SLOTS = {
    ...
    # --- Reseller API screen ---
    "api_title":     ("📗", "API: screen title",    "Reseller API"),
    "api_on":        ("🟢", "API: active status",   "Reseller API"),
    "api_off":       ("⚪️", "API: no key yet",      "Reseller API"),
    "api_wallet":    ("👛", "API: balance line",    "Reseller API"),
    "api_key":       ("🔑", "API: key line",        "Reseller API"),
    "api_orders":    ("📦", "API: orders placed",   "Reseller API"),
    "api_spend":     ("💵", "API: spend line",      "Reseller API"),
    "api_new":       ("🔑", "API: Generate key button",   "Reseller API"),
    "api_rotate":    ("♻️", "API: Rotate key button",     "Reseller API"),
    "api_del":       ("🗑", "API: Delete key button",     "Reseller API"),
    "api_docs":      ("📗", "API: Documentation button",  "Reseller API"),
    "api_refresh":   ("🔄", "API: Refresh button",        "Reseller API"),
